...
{
    // Stats
    handlers_[notify_type::hp] = [this](game_state_manager&, packet_reader& r)
    {
        handle_hp(r);
    };
    handlers_[notify_type::mp] = [this](game_state_manager&, packet_reader& r)
    {
        handle_mp(r);
    };
    handlers_[notify_type::sp] = [this](game_state_manager&, packet_reader& r)
    {
        handle_sp(r);
    };
    handlers_[notify_type::exp] = [this](game_state_manager&, packet_reader& r)
    {
        handle_exp(r);
    };
    handlers_[notify_type::level_up] = [this](game_state_manager&, packet_reader& r)
    {
        handle_level_up(r);
    };
    handlers_[notify_type::charisma] = [this](game_state_manager&, packet_reader& r)
    {
        handle_charisma(r);
    };
    handlers_[notify_type::hunger] = [this](game_state_manager&, packet_reader& r)
    {
        handle_hunger(r);
    };

    // Combat
    handlers_[notify_type::killed] = [this](game_state_manager&, packet_reader& r)
    {
        handle_killed(r);
    };
    handlers_[notify_type::damage_move] = [this](game_state_manager&, packet_reader& r)
    {
        handle_damage_move(r);
    };
    handlers_[notify_type::safe_attack_mode] = [this](game_state_manager&, packet_reader& r)
    {
        handle_safe_attack_mode(r);
    };
    handlers_[notify_type::super_attack_left] = [this](game_state_manager&, packet_reader& r)
    {
        handle_super_attack_left(r);
    };
    handlers_[notify_type::global_attack_mode] = [this](game_state_manager&, packet_reader& r)
    {
        handle_global_attack_mode(r);
    };

    // Magic/Skills
    handlers_[notify_type::skill] = [this](game_state_manager&, packet_reader& r)
    {
        handle_skill(r);
    };
    handlers_[notify_type::magic_effect_on] = [this](game_state_manager&, packet_reader& r)
    {
        handle_magic_effect_on(r);
    };
    handlers_[notify_type::magic_effect_off] = [this](game_state_manager&, packet_reader& r)
    {
        handle_magic_effect_off(r);
    };
    handlers_[notify_type::magic_study_success] = [this](game_state_manager&, packet_reader& r)
    {
        handle_magic_study_success(r);
    };
    handlers_[notify_type::magic_study_fail] = [this](game_state_manager&, packet_reader& r)
    {
        handle_magic_study_fail(r);
    };
    handlers_[notify_type::skill_train_success] = [this](game_state_manager&, packet_reader& r)
    {
        handle_skill_train_success(r);
    };
    handlers_[notify_type::skill_train_fail] = [this](game_state_manager&, packet_reader& r)
    {
        handle_skill_train_fail(r);
    };
    handlers_[notify_type::skill_using_end] = [this](game_state_manager&, packet_reader& r)
    {
        handle_skill(r);
    };

    // Items
    handlers_[notify_type::item_obtained] = [this](game_state_manager&, packet_reader& r)
    {
        handle_item_obtained(r);
    };
    handlers_[notify_type::drop_item_fin_erase_item] = [this](game_state_manager&, packet_reader& r)
    {
        handle_item_drop(r);
    };
    handlers_[notify_type::give_item_fin_erase_item] = [this](game_state_manager&, packet_reader& r)
    {
        handle_item_drop(r);
    };
    handlers_[notify_type::item_depleted_erase_item] = [this](game_state_manager&, packet_reader& r)
    {
        handle_item_drop(r);
    };
    handlers_[notify_type::item_to_bank] = [this](game_state_manager&, packet_reader& r)
    {
        handle_item_to_bank(r);
    };
    handlers_[notify_type::cannot_item_to_bank] = [this](game_state_manager&, packet_reader& r)
    {
        handle_cannot_item_to_bank(r);
    };
    handlers_[notify_type::set_item_count] = [this](game_state_manager&, packet_reader& r)
    {
        handle_set_item_count(r);
    };
    handlers_[notify_type::item_lifespan_end] = [this](game_state_manager&, packet_reader& r)
    {
        handle_item_lifespan_end(r);
    };
    handlers_[notify_type::item_released] = [this](game_state_manager&, packet_reader& r)
    {
        handle_item_released(r);
    };
    handlers_[notify_type::item_color_change] = [this](game_state_manager&, packet_reader& r)
    {
        handle_item_color_change(r);
    };
    handlers_[notify_type::item_attribute_change] = [this](game_state_manager&, packet_reader& r)
    {
        handle_item_attribute_change(r);
    };
    handlers_[notify_type::cannot_carry_more_item] = [this](game_state_manager&, packet_reader& r)
    {
        handle_cannot_carry_more_item(r);
    };

    // Shop/Trade
    handlers_[notify_type::item_purchased] = [this](game_state_manager&, packet_reader& r)
    {
        handle_item_purchased(r);
    };
    handlers_[notify_type::not_enough_gold] = [this](game_state_manager&, packet_reader& r)
    {
        handle_not_enough_gold(r);
    };
    handlers_[notify_type::sell_item_price] = [this](game_state_manager&, packet_reader& r)
    {
        handle_sell_item_price(r);
    };
    handlers_[notify_type::cannot_sell_item] = [this](game_state_manager&, packet_reader& r)
    {
        handle_cannot_sell_item(r);
    };
    handlers_[notify_type::item_sold] = [this](game_state_manager&, packet_reader& r)
    {
        handle_item_sold(r);
    };
    handlers_[notify_type::repair_item_price] = [this](game_state_manager&, packet_reader& r)
    {
        handle_repair_item_price(r);
    };
    handlers_[notify_type::cannot_repair_item] = [this](game_state_manager&, packet_reader& r)
    {
        handle_cannot_repair_item(r);
    };
    handlers_[notify_type::item_repaired] = [this](game_state_manager&, packet_reader& r)
    {
        handle_item_repaired(r);
    };
    handlers_[notify_type::reward_gold] = [this](game_state_manager&, packet_reader& r)
    {
        handle_reward_gold(r);
    };

    // Exchange
    handlers_[notify_type::open_exchange_window] = [this](game_state_manager&, packet_reader& r)
    {
        handle_open_exchange_window(r);
    };
    handlers_[notify_type::set_exchange_item] = [this](game_state_manager&, packet_reader& r)
    {
        handle_set_exchange_item(r);
    };
    handlers_[notify_type::cancel_exchange_item] = [this](game_state_manager&, packet_reader& r)
    {
        handle_cancel_exchange_item(r);
    };
    handlers_[notify_type::exchange_item_complete] = [this](game_state_manager&, packet_reader& r)
    {
        handle_exchange_item_complete(r);
    };

    // Guild
    handlers_[notify_type::guild_disbanded] = [this](game_state_manager&, packet_reader& r)
    {
        handle_guild_disbanded(r);
    };
    handlers_[notify_type::new_guildsman] = [this](game_state_manager&, packet_reader& r)
    {
        handle_new_guildsman(r);
    };
    handlers_[notify_type::dismiss_guildsman] = [this](game_state_manager&, packet_reader& r)
    {
        handle_dismiss_guildsman(r);
    };
    handlers_[notify_type::query_join_guild_permission] = [this](game_state_manager&, packet_reader& r)
    {
        handle_query_join_guild_permission(r);
    };
    handlers_[notify_type::query_dismiss_guild_permission] = [this](game_state_manager&, packet_reader& r)
    {
        handle_query_dismiss_guild_permission(r);
    };
    handlers_[notify_type::wait_for_guild_operation] = [this](game_state_manager&, packet_reader& r)
    {
        handle_wait_for_guild_operation(r);
    };
    handlers_[notify_type::cannot_join_more_guildsman] = [this](game_state_manager&, packet_reader& r)
    {
        handle_cannot_join_more_guildsman(r);
    };

    // Party
    handlers_[notify_type::party] = [this](game_state_manager&, packet_reader& r)
    {
        handle_party(r);
    };
    handlers_[notify_type::response_create_new_party] = [this](game_state_manager&, packet_reader& r)
    {
        handle_response_create_new_party(r);
    };
    handlers_[notify_type::query_join_party] = [this](game_state_manager&, packet_reader& r)
    {
        handle_query_join_party(r);
    };

    // Quest
    handlers_[notify_type::quest_contents] = [this](game_state_manager&, packet_reader& r)
    {
        handle_quest_contents(r);
    };
    handlers_[notify_type::quest_completed] = [this](game_state_manager&, packet_reader& r)
    {
        handle_quest_completed(r);
    };
    handlers_[notify_type::quest_reward] = [this](game_state_manager&, packet_reader& r)
    {
        handle_quest_reward(r);
    };

    // Crafting
    handlers_[notify_type::build_item_success] = [this](game_state_manager&, packet_reader& r)
    {
        handle_build_item_success(r);
    };
    handlers_[notify_type::build_item_fail] = [this](game_state_manager&, packet_reader& r)
    {
        handle_build_item_fail(r);
    };
    handlers_[notify_type::portion_success] = [this](game_state_manager&, packet_reader& r)
    {
        handle_portion_success(r);
    };
    handlers_[notify_type::item_upgrade_fail] = [this](game_state_manager&, packet_reader& r)
    {
        handle_item_upgrade_fail(r);
    };

    // Fishing
    handlers_[notify_type::fish_chance] = [this](game_state_manager&, packet_reader& r)
    {
        handle_fish_chance(r);
    };
    handlers_[notify_type::fish_success] = [this](game_state_manager&, packet_reader& r)
    {
        handle_fish_success(r);
    };
    handlers_[notify_type::fish_fail] = [this](game_state_manager&, packet_reader& r)
    {
        handle_fish_fail(r);
    };

    // PK/Combat
    handlers_[notify_type::pk_penalty] = [this](game_state_manager&, packet_reader& r)
    {
        handle_pk_penalty(r);
    };
    handlers_[notify_type::pk_captured] = [this](game_state_manager&, packet_reader& r)
    {
        handle_pk_captured(r);
    };
    handlers_[notify_type::enemy_kill_reward] = [this](game_state_manager&, packet_reader& r)
    {
        handle_enemy_kill_reward(r);
    };
    handlers_[notify_type::enemy_kills] = [this](game_state_manager&, packet_reader& r)
    {
        handle_enemy_kills(r);
    };

    // Crusade/War
    handlers_[notify_type::crusade] = [this](game_state_manager&, packet_reader& r)
    {
        handle_crusade(r);
    };
    handlers_[notify_type::locked_map] = [this](game_state_manager&, packet_reader& r)
    {
        handle_locked_map(r);
    };
    handlers_[notify_type::duty_selected] = [this](game_state_manager&, packet_reader& r)
    {
        handle_duty_selected(r);
    };
    handlers_[notify_type::map_status_next] = [this](game_state_manager&, packet_reader& r)
    {
        handle_map_status_next(r);
    };
    handlers_[notify_type::map_status_last] = [this](game_state_manager&, packet_reader& r)
    {
        handle_map_status_last(r);
    };
    handlers_[notify_type::meteor_strike_coming] = [this](game_state_manager&, packet_reader& r)
    {
        handle_meteor_strike_coming(r);
    };
    handlers_[notify_type::meteor_strike_hit] = [this](game_state_manager&, packet_reader& r)
    {
        handle_meteor_strike_hit(r);
    };
    handlers_[notify_type::grand_magic_result] = [this](game_state_manager&, packet_reader& r)
    {
        handle_grand_magic_result(r);
    };

    // Special abilities
    handlers_[notify_type::energy_sphere_created] = [this](game_state_manager&, packet_reader& r)
    {
        handle_energy_sphere_created(r);
    };
    handlers_[notify_type::energy_sphere_goal_in] = [this](game_state_manager&, packet_reader& r)
    {
        handle_energy_sphere_goal_in(r);
    };
    handlers_[notify_type::special_ability_enabled] = [this](game_state_manager&, packet_reader& r)
    {
        handle_special_ability_enabled(r);
    };
    handlers_[notify_type::special_ability_status] = [this](game_state_manager&, packet_reader& r)
    {
        handle_special_ability_status(r);
    };

    // World events
    handlers_[notify_type::new_dynamic_object] = [this](game_state_manager&, packet_reader& r)
    {
        handle_new_dynamic_object(r);
    };
    handlers_[notify_type::del_dynamic_object] = [this](game_state_manager&, packet_reader& r)
    {
        handle_del_dynamic_object(r);
    };
    handlers_[notify_type::weather_change] = [this](game_state_manager&, packet_reader& r)
    {
        handle_weather_change(r);
    };
    handlers_[notify_type::time_change] = [this](game_state_manager&, packet_reader& r)
    {
        handle_time_change(r);
    };

    // System
    handlers_[notify_type::event_msg_string] = [this](game_state_manager&, packet_reader& r)
    {
        handle_event_msg_string(r);
    };
    handlers_[notify_type::server_shutdown] = [this](game_state_manager&, packet_reader& r)
    {
        handle_server_shutdown(r);
    };
    handlers_[notify_type::total_users] = [this](game_state_manager&, packet_reader& r)
    {
        handle_total_users(r);
    };
    handlers_[notify_type::force_disconn] = [this](game_state_manager&, packet_reader& r)
    {
        handle_force_disconn(r);
    };

    // Misc
    handlers_[notify_type::npc_talk] = [this](game_state_manager&, packet_reader& r)
    {
        handle_npc_talk(r);
    };
    handlers_[notify_type::player_profile] = [this](game_state_manager&, packet_reader& r)
    {
        handle_player_profile(r);
    };
    handlers_[notify_type::player_on_game] = [this](game_state_manager&, packet_reader& r)
    {
        handle_player_on_game(r);
    };
    handlers_[notify_type::player_not_on_game] = [this](game_state_manager&, packet_reader& r)
    {
        handle_player_not_on_game(r);
    };
    handlers_[notify_type::whisper_mode_on] = [this](game_state_manager&, packet_reader& r)
    {
        handle_whisper_mode_on(r);
    };
    handlers_[notify_type::whisper_mode_off] = [this](game_state_manager&, packet_reader& r)
    {
        handle_whisper_mode_off(r);
    };
    handlers_[notify_type::player_shutup] = [this](game_state_manager&, packet_reader& r)
    {
        handle_player_shutup(r);
    };
    handlers_[notify_type::to_be_recalled] = [this](game_state_manager&, packet_reader& r)
    {
        handle_to_be_recalled(r);
    };
    handlers_[notify_type::show_map] = [this](game_state_manager&, packet_reader& r)
    {
        handle_show_map(r);
    };
    handlers_[notify_type::server_change] = [this](game_state_manager&, packet_reader& r)
    {
        handle_server_change(r);
    };
    handlers_[notify_type::observer_mode] = [this](game_state_manager&, packet_reader& r)
    {
        handle_observer_mode(r);
    };
    handlers_[notify_type::limited_level] = [this](game_state_manager&, packet_reader& r)
    {
        handle_limited_level(r);
    };
}
