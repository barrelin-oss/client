...
public:
    ...
    {
        assert(stats_.has_value() && "stats component required");
        return stats_.value();
    }
    const stats_component& stats() const
    {
        assert(stats_.has_value() && "stats component required");
        return stats_.value();
    }
    ...
    {
        assert(combat_.has_value() && "combat component required");
        return combat_.value();
    }
    const combat_component& combat() const
    {
        assert(combat_.has_value() && "combat component required");
        return combat_.value();
    }
    ...
    name_component& name()
    {
        assert(name_.has_value() && "name component required");
        return name_.value();
    }
    const name_component& name() const
    {
        assert(name_.has_value() && "name component required");
        return name_.value();
    }
    ...
    {
        assert(movement_.has_value() && "movement component required");
        return movement_.value();
    }
    const movement_component& movement() const
    {
        assert(movement_.has_value() && "movement component required");
        return movement_.value();
    }
    ...
    npc_component& npc()
    {
        assert(npc_.has_value() && "npc component required");
        return npc_.value();
    }
    const npc_component& npc() const
    {
        assert(npc_.has_value() && "npc component required");
        return npc_.value();
    }
    ...
    monster_component& monster()
    {
        assert(monster_.has_value() && "monster component required");
        return monster_.value();
    }
    const monster_component& monster() const
    {
        assert(monster_.has_value() && "monster component required");
        return monster_.value();
    }
    ...
    item_component& item()
    {
        assert(item_.has_value() && "item component required");
        return item_.value();
    }
    const item_component& item() const
    {
        assert(item_.has_value() && "item component required");
        return item_.value();
    }
    ...
    {
        assert(effect_.has_value() && "effect component required");
        return effect_.value();
    }
    const effect_component& effect() const
    {
        assert(effect_.has_value() && "effect component required");
        return effect_.value();
    }
