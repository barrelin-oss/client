...
inline std::string get_chat_prefix(chat_type type) {
    switch (type) {
        ...
        case chat_type::faction: return "[Faction] ";
        default:                 return "";
    }
}
...
inline text_style get_chat_bubble_style(std::string_view channel)
{
    ...
    else if (channel == "party")    color = {230, 230, 130};
    else if (channel == "faction")  color = {130, 130, 255};
    else if (channel == "gm")
...
inline text_style get_chat_bubble_style(chat_type type)
{
    ...
    switch (type)
    {
        ...
        case chat_type::party:   color = {230, 230, 130}; break;
        case chat_type::gm:
            return {{100, 255, 255}, sf::Color::Black, 1.0f, 12, text_effect::outline_pulse};
        ...
        case chat_type::faction: color = {130, 130, 255}; break;
    }
