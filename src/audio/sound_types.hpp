...
{
    return is_male_player_type(player_type) ? character_sound::male_hurt : character_sound::female_hurt;
}

// Get death sound based on player type (gender)
inline character_sound get_death_sound(int player_type)
{
    return is_male_player_type(player_type) ? character_sound::male_death : character_sound::female_death;
}

// Get level up sound based on player type (gender)
inline character_sound get_level_up_sound(int player_type)
{
    return is_male_player_type(player_type) ? character_sound::male_level_up : character_sound::female_level_up;
}

// Get eat/consume food sound based on player type (gender)
inline character_sound get_eat_sound(int player_type)
{
    return is_male_player_type(player_type) ? character_sound::male_eat : character_sound::female_eat;
}

// Get critical hit / super attack sound based on player type (gender)
inline character_sound get_critical_sound(int player_type)
{
    return is_male_player_type(player_type) ? character_sound::male_critical : character_sound::female_critical;
}
