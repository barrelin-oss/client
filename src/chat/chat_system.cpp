...
bool chat_system::should_show_message(const chat_message& msg) const
{
    ...
    case chat_type::normal:
        return config_.show_normal;
    case chat_type::shout:
        return config_.show_shout;
    case chat_type::whisper:
        return config_.show_whisper;
    case chat_type::guild:
        return config_.show_guild;
    case chat_type::party:
        return config_.show_party;
    case chat_type::system:
        return config_.show_system;
    case chat_type::trade:
        return config_.show_trade;
    case chat_type::global:
        return config_.show_global;
    default:
        return true;
    }
}
