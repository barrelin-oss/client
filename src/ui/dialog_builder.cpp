...
dialog_builder& dialog_builder::label(
    std::string_view id, int32_t x, int32_t y, std::string_view text, sf::Color color, uint32_t font_size)
{
...
dialog_builder& dialog_builder::button_styled(std::string_view id,
                                              int32_t x,
                                              int32_t y,
                                              int32_t w,
                                              int32_t h,
...
dialog_builder& dialog_builder::sprite_button(std::string_view id,
                                              int32_t x,
                                              int32_t y,
                                              std::string_view pak,
                                              int32_t sprite_idx,
...
dialog_builder& dialog_builder::text_input(
    std::string_view id, int32_t x, int32_t y, int32_t w, int32_t h, int32_t max_chars, bool password)
{
...
dialog_builder& dialog_builder::image(
    std::string_view id, int32_t x, int32_t y, std::string_view pak, int32_t sprite_idx, int32_t frame)
{
...
dialog_builder& dialog_builder::progress_bar(
    std::string_view id, int32_t x, int32_t y, int32_t w, int32_t h, sf::Color fill, sf::Color bg)
{
...
dialog_builder& dialog_builder::checkbox(std::string_view id, int32_t x, int32_t y, std::string_view label_text)
{
...
dialog_builder& dialog_builder::slider(
    std::string_view id, int32_t x, int32_t y, int32_t w, int32_t h, float min_val, float max_val, float step)
{
...
dialog_builder& dialog_builder::list_box(std::string_view id, int32_t x, int32_t y, int32_t w, int32_t h)
{
...
dialog_builder& dialog_builder::grid(std::string_view id,
                                     int32_t x,
                                     int32_t y,
                                     int32_t cols,
                                     int32_t rows,
...
dialog_builder& dialog_builder::panel(std::string_view id, int32_t x, int32_t y, int32_t w, int32_t h, sf::Color bg)
{
...
dialog_builder& dialog_builder::sprite(
    std::string_view id, int32_t x, int32_t y, std::string_view pak, int32_t sprite_idx, int32_t frame)
{
