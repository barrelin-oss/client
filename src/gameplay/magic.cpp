...
bool magic_system::can_cast_at_target(uint16_t spell_id, uint32_t caster_id, uint32_t target_id) const
{
    ...
    // Check range
    if (!check_range(caster_id, target_id, s->range))
        return false;
...
bool magic_system::can_cast_at_location(uint16_t spell_id, uint32_t caster_id, int32_t x, int32_t y) const
{
    ...
    // Check range
    if (!check_range_location(caster_id, x, y, s->range))
        return false;

    // Must be ground-targeted or area spell
    if (s->target_type != spell_target::ground && s->target_type != spell_target::area)
        return false;
...
{
    if (!can_cast_at_target(spell_id, caster_id, target_id))
        return false;
...
{
    if (!can_cast_at_location(spell_id, caster_id, x, y))
        return false;
...
spell_cast_result
magic_system::execute_spell(uint16_t spell_id, uint32_t caster_id, uint32_t target_id, int32_t magic_power)
{
    spell_cast_result result;
...
spell_cast_result magic_system::execute_spell_at_location(
    uint16_t spell_id, [[maybe_unused]] uint32_t caster_id, int32_t x, int32_t y, int32_t magic_power)
{
    spell_cast_result result;
...
{
    active_effects_.erase(std::remove_if(active_effects_.begin(),
                                         active_effects_.end(),
...
void magic_system::load_default_spells()
{
    ...
    auto set_circle = [](spell& s)
    {
        s.circle = static_cast<uint8_t>(s.id / 10 + 1);
    };
    ...
    add({.id = spell_id::magic_missile,
         .name = "Magic Missile",
         .description = "Fast magic projectile",
         .category = spell_category::attack,
         .target_type = spell_target::single,
         .type = magic_type::damage_spot,
         .element = magic_element::lightning,
         .int_req = 18,
         .mp_cost = 8,
         .base_damage = 8,
         .range = 8,
         .projectile_effect = 100,
         .effect_sprite = 7,
         .cast_time = 0.5f});

    add({.id = spell_id::heal,
         .name = "Heal",
         .description = "Restore health",
         .category = spell_category::healing,
         .target_type = spell_target::single,
    ...
    add({.id = spell_id::energy_bolt,
         .name = "Energy Bolt",
         .description = "Concentrated energy blast",
         .category = spell_category::attack,
         .target_type = spell_target::area,
         .type = magic_type::damage_area,
         .element = magic_element::lightning,
         .int_req = 24,
         .mp_cost = 15,
         .base_damage = 10,
         .range = 8,
         .aoe_radius = 2,
         .projectile_effect = 110,
         .effect_sprite = 6,
         .cast_time = 0.7f});

    add({.id = spell_id::staminar_drain,
         .name = "Stamina Drain",
         .description = "Drain target stamina",
         .category = spell_category::debuff,
         .target_type = spell_target::single,
    ...
    add({.id = spell_id::defense_shield,
         .name = "Defense Shield",
    ...
    add({.id = spell_id::celebrating_light,
         .name = "Celebrating Light",
    ...
    add({.id = spell_id::fire_ball,
         .name = "Fire Ball",
         .description = "Explosive fire magic",
         .category = spell_category::attack,
         .target_type = spell_target::area,
         .type = magic_type::damage_area,
         .element = magic_element::fire,
         .int_req = 26,
         .mp_cost = 27,
         .base_damage = 16,
         .range = 8,
         .aoe_radius = 2,
         .projectile_effect = 120,
         .effect_sprite = 5,
         .cast_time = 1.0f});

    add({.id = spell_id::great_heal,
         .name = "Great Heal",
    ...
    add({.id = spell_id::staminar_recovery,
    ...
    add({.id = spell_id::protection_from_arrow,
         .name = "Protection from Arrow",
    ...
    add({.id = spell_id::poison,
         .name = "Poison",
         .description = "Damage over time",
         .category = spell_category::debuff,
         .target_type = spell_target::single,
         .type = magic_type::poison,
         .element = magic_element::earth,
         .int_req = 29,
         .mp_cost = 28,
         .base_damage = 15,
         .range = 8,
    ...
    add({.id = spell_id::great_staminar_recovery,
         .name = "Great Stamina Recovery",
    ...
    add({.id = spell_id::fire_strike,
         ...
         .range = 8,
         .aoe_radius = 2,
         .projectile_effect = 130,
         .effect_sprite = 5,
         .cast_time = 1.0f});

    add({.id = spell_id::summon_creature,
         .name = "Summon Creature",
         .description = "Summon a creature to fight",
         .category = spell_category::summon,
         .target_type = spell_target::ground,
         .type = magic_type::summon,
         .element = magic_element::earth,
         .int_req = 38,
         .mp_cost = 35,
         .range = 6,
    ...
    add({.id = spell_id::protection_from_magic,
    ...
    add({.id = spell_id::detect_invisibility,
    ...
    add({.id = spell_id::lightning_arrow,
         ...
         .base_damage = 30,
         .range = 8,
         .projectile_effect = 137,
         .effect_sprite = 63,
         .cast_time = 0.5f});

    add({.id = spell_id::tremor,
         .name = "Tremor",
         .description = "Shake the earth",
         .category = spell_category::attack,
         .target_type = spell_target::area,
         .type = magic_type::tremor,
         .element = magic_element::earth,
         .int_req = 33,
         .mp_cost = 34,
         .base_damage = 18,
    ...
    add({.id = spell_id::fire_wall,
         .name = "Fire Wall",
         .description = "Create a wall of fire",
         .category = spell_category::attack,
         .target_type = spell_target::ground,
         .type = magic_type::create_dynamic,
         .element = magic_element::fire,
         .int_req = 45,
         .mp_cost = 42,
         .base_damage = 16,
    ...
    add({.id = spell_id::confuse_language,
    ...
    add({.id = spell_id::great_defense_shield,
         .name = "Great Defense Shield",
    ...
    add({.id = spell_id::chill_wind,
         .name = "Chill Wind",
         .description = "Icy wind that damages and slows",
         .category = spell_category::attack,
         .target_type = spell_target::area,
         .type = magic_type::ice,
         .element = magic_element::ice,
         .int_req = 50,
         .mp_cost = 48,
         .base_damage = 22,
         .range = 8,
    ...
    add({.id = spell_id::triple_energy_bolt,
         ...
         .range = 8,
         .aoe_radius = 2,
         .projectile_effect = 147,
         .cast_time = 0.8f});

    // === Level 6 (IDs 50-59) ===

    add({.id = spell_id::berserk,
         .name = "Berserk",
    ...
    add({.id = spell_id::lightning_bolt,
         .name = "Lightning Bolt",
         ...
         .range = 8,
         .aoe_radius = 2,
         .projectile_effect = 151,
         .cast_time = 0.8f});

    add({.id = spell_id::mass_poison,
         .name = "Mass Poison",
    ...
    add({.id = spell_id::mass_lightning_arrow,
         .name = "Mass Lightning Arrow",
         ...
         .base_damage = 50,
         .range = 8,
         .projectile_effect = 156,
         .cast_time = 0.5f});

    add({.id = spell_id::ice_strike,
         .name = "Ice Strike",
    ...
    add({.id = spell_id::energy_strike,
         .name = "Energy Strike",
         .description = "Massive energy attack",
         .category = spell_category::attack,
         .target_type = spell_target::area,
         .type = magic_type::damage_area_no_spot,
         .element = magic_element::lightning,
         .int_req = 67,
         .mp_cost = 65,
         .base_damage = 59,
         .range = 8,
         .aoe_radius = 2,
         .projectile_effect = 160,
         .cast_time = 1.0f});

    add({.id = spell_id::mass_fire_strike,
         ...
         .range = 8,
         .aoe_radius = 2,
         .projectile_effect = 161,
         .cast_time = 1.5f});

    add({.id = spell_id::confusion,
         .name = "Confusion",
    ...
    add({.id = spell_id::mass_chill_wind,
    ...
    add({.id = spell_id::earthworm_strike,
         .name = "Earthworm Strike",
         .description = "Earth erupts under enemies",
         .category = spell_category::attack,
         .target_type = spell_target::area,
         .type = magic_type::earthworm_strike,
         .element = magic_element::earth,
         .int_req = 97,
         .mp_cost = 80,
         .base_damage = 59,
    ...
    add({.id = spell_id::absolute_magic_protection,
    ...
    add({.id = spell_id::armor_break,
         .name = "Armor Break",
         .description = "Destroy target armor",
         .category = spell_category::debuff,
         .target_type = spell_target::single,
         .type = magic_type::armor_break,
         .element = magic_element::earth,
         .int_req = 97,
         .mp_cost = 90,
         .base_damage = 59,
    ...
    add({.id = spell_id::bloody_shock_wave,
         .name = "Bloody Shock Wave",
         .description = "Devastating shockwave",
         .category = spell_category::attack,
         .target_type = spell_target::area,
         .type = magic_type::bloody_shock_wave,
         .element = magic_element::lightning,
         .int_req = 105,
         .mp_cost = 180,
         .base_damage = 60,
         .range = 8,
         .aoe_radius = 2,
         .projectile_effect = 170,
         .cast_time = 2.0f});

    add({.id = spell_id::mass_confusion,
         .name = "Mass Confusion",
    ...
    add({.id = spell_id::mass_ice_strike,
    ...
    add({.id = spell_id::lightning_strike,
         ...
         .range = 8,
         .aoe_radius = 2,
         .projectile_effect = 174,
         .cast_time = 1.0f});

    add({.id = spell_id::cancellation,
         .name = "Cancellation",
    ...
    add({.id = spell_id::illusion_movement,
    ...
    add({.id = spell_id::mass_magic_missile,
         .name = "Mass Magic Missile",
         .description = "Magic missiles strike all",
         .category = spell_category::attack,
         .target_type = spell_target::area,
         .type = magic_type::mass_magic_missile,
         .element = magic_element::lightning,
         .int_req = 185,
         .mp_cost = 160,
         .base_damage = 72,
         .range = 8,
         .aoe_radius = 2,
         .projectile_effect = 182,
         .effect_sprite = 36,
         .cast_time = 1.5f});

    add({.id = spell_id::inhibition_casting,
         .name = "Inhibition Casting",
    ...
    add({.id = spell_id::blizzard,
         .name = "Blizzard",
         .description = "Devastating ice storm",
         .category = spell_category::attack,
         .target_type = spell_target::area,
         .type = magic_type::blizzard,
         .element = magic_element::ice,
         .int_req = 195,
         .mp_cost = 170,
         .base_damage = 72,
         .range = 8,
         .aoe_radius = 2,
         .projectile_effect = 191,
         .cast_time = 2.5f});

    add({.id = spell_id::resurrection,
         .name = "Resurrection",
         .description = "Bring the dead back to life",
         .category = spell_category::healing,
         .target_type = spell_target::single,
         .type = magic_type::resurrection,
         .element = magic_element::ice,
         .int_req = 0,
         .mp_cost = 200,
         .base_healing = 60,
    ...
    add({.id = spell_id::mass_illusion_movement,
    ...
    add({.id = spell_id::earth_shock_wave,
         .name = "Earth Shock Wave",
         .description = "Devastating earth attack",
         .category = spell_category::attack,
         .target_type = spell_target::area,
         .type = magic_type::earth_shock_wave,
         .element = magic_element::earth,
         .int_req = 200,
         .mp_cost = 180,
         .base_damage = 72,
