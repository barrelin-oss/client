...
struct stat_formulas {
    ...
    static int32_t calculate_max_sp(uint16_t strength, uint16_t level) {
    ...
    static int32_t calculate_dodge_ratio(uint16_t dexterity, uint16_t level) {
        return (dexterity / 4) + (level / 4);
    }
