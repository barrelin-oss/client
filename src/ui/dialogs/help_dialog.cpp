...
help_dialog::help_dialog() : dialog(dialog_type::help)
{
    set_title("Help");
...
void help_dialog::render_content_area(renderer& rend, int32_t x, int32_t y, int32_t width, int32_t height)
{
    ...
    int32_t line_y = y + 28;
    int32_t end_line =
        std::min(content_scroll_ + visible_content_lines, static_cast<int32_t>(topic->content_lines.size()));
...
void help_dialog::load_default_help()
{
    ...
    // Basics (category 0)
    topics_.push_back({"Getting Started",
    ...
    // Combat (category 1)
    topics_.push_back({"Basic Combat",
                       {"#Combat Basics",
                        "",
    ...
    topics_.push_back({"Super Attacks",
                       {"#Super Attacks",
                        "",
    ...
    // Magic (category 2)
    topics_.push_back({"Casting Spells",
                       {"#Using Magic",
                        "",
    ...
    topics_.push_back({"Spell Circles",
                       {"#Magic Circles",
                        "",
    ...
    topics_.push_back({"Chat Commands",
                       {"#Chat Prefixes",
                        "",
