...
struct item_effect_data {
    ...
    int32_t get_resistance_bonus() const {
        switch (effect_type) {
            case item_effect_type::fire_resistance: return effect_value * 4;
            case item_effect_type::water_resistance: return effect_value * 5;
            case item_effect_type::ice_resistance: return effect_value * 7;
            case item_effect_type::earth_resistance: return effect_value * 3;
            case item_effect_type::poison_resistance: return effect_value;
            default: return 0;
        }
    }
    ...
    int32_t get_damage_bonus() const {
        switch (effect_type) {
            case item_effect_type::super_attack_bonus: return effect_value;
            case item_effect_type::critical_bonus: return effect_value;
            default: return 0;
        }
    }
...
struct item {
    ...
    bool is_armor() const { return slot == equip_slot::body || slot == equip_slot::pants ||
                                   slot == equip_slot::boots || slot == equip_slot::arms; }
    bool is_accessory() const { return slot == equip_slot::neck || slot == equip_slot::left_finger ||
    ...
    item_effect_data get_effect_data() const {
        return item_effect_data::from_attribute(attribute);
    }
    ...
    bool add_bonus(item_attribute attr, int16_t value) {
        if (bonus_count >= max_bonuses) return false;
    ...
    int32_t roll_damage() const {
        if (damage_min >= damage_max) return damage_min;
