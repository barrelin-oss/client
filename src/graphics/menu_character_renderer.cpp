...
template<size_t N> static void load_pak_array(sprite_manager& sprites, const std::array<pak_load_entry, N>& entries)
{
...
void menu_character_renderer::draw(renderer& rend,
                                   ...
                                   int32_t frame)
{
    ...
    {
        draw_hair(rend, sprites, x, y, gender, appearance.hair_style, appearance.hair_color, action, dir, frm);
    }
...
void menu_character_renderer::draw_with_shadow(renderer& rend,
                                               sprite_manager& sprites,
                                               int32_t x,
                                               int32_t y,
                                               const character_appearance& appearance,
...
void menu_character_renderer::draw_body(renderer& rend,
                                        sprite_manager& sprites,
                                        int32_t x,
                                        int32_t y,
                                        uint8_t gender,
...
void menu_character_renderer::draw_underwear(renderer& rend,
                                             sprite_manager& sprites,
                                             int32_t x,
                                             int32_t y,
                                             uint8_t gender,
...
void menu_character_renderer::draw_hair(renderer& rend,
                                        sprite_manager& sprites,
                                        int32_t x,
                                        int32_t y,
                                        uint8_t gender,
...
void menu_character_renderer::draw_body_armor(renderer& rend,
                                              sprite_manager& sprites,
                                              int32_t x,
                                              int32_t y,
                                              uint8_t gender,
...
void menu_character_renderer::draw_arm_armor(renderer& rend,
                                             sprite_manager& sprites,
                                             int32_t x,
                                             int32_t y,
                                             uint8_t gender,
...
void menu_character_renderer::draw_pants(renderer& rend,
                                         sprite_manager& sprites,
                                         int32_t x,
                                         int32_t y,
                                         uint8_t gender,
...
void menu_character_renderer::draw_boots(renderer& rend,
                                         sprite_manager& sprites,
                                         int32_t x,
                                         int32_t y,
                                         uint8_t gender,
...
void menu_character_renderer::draw_helmet(renderer& rend,
                                          sprite_manager& sprites,
                                          int32_t x,
                                          int32_t y,
                                          uint8_t gender,
...
void menu_character_renderer::draw_mantle(renderer& rend,
                                          sprite_manager& sprites,
                                          int32_t x,
                                          int32_t y,
                                          uint8_t gender,
...
void menu_character_renderer::draw_weapon(renderer& rend,
                                          sprite_manager& sprites,
                                          int32_t x,
                                          int32_t y,
                                          uint8_t gender,
...
void menu_character_renderer::draw_shield(renderer& rend,
                                          sprite_manager& sprites,
                                          int32_t x,
                                          int32_t y,
                                          uint8_t gender,
